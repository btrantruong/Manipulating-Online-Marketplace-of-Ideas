...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', f'10202022_baseline_{exp_type}_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', f'10202022_baseline_{exp_type}_{sim_num}runs')
