...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', f'09222022_strategies_{exp_type}_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', f'09222022_strategies_{exp_type}_{sim_num}runs')
