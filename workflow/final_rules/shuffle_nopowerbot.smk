...
# ! Note: Before running make sure config_10102022/shuffle/* exists
# `shuffle` contains .json configs copied from vary_gamma/*0.json (where gamma=10^-4) - BOTS HAVE NO POWER
...
mode='igraph'
sim_num=2
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', f'10102022_shuffled_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', f'10102022_shuffled_{sim_num}runs')
