...
mode='igraph'
sim_num=3
RES_DIR = os.path.join(ABS_PATH,'results', 'short', f'11262022_shuffle_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results', 'verbose', f'11262022_shuffle_{sim_num}runs')
