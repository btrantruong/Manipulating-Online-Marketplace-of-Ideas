...
DATA_PATH = os.path.join(ABS_PATH, 'data')
CONFIG_PATH = os.path.join(ABS_PATH, "config_09102022_onepctbot")
...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', f'09102022_onepctbot__{exp_type}_{sim_num}runs')
