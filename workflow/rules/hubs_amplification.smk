"""
Run simulations on random & hubs network where the quality of human content is decide by a coin toss
...
mode='igraph'
sim_num=3
RES_DIR = os.path.join(ABS_PATH,'results', 'short', f'01132023_hubsamp_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results', 'verbose', f'01132023_hubsamp_{sim_num}runs')
