...
config_fname = os.path.join(ABS_PATH, "data_hiepsilon", 'all_configs.json')
...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', '%s_hiepsilon_%sruns' %(exp_type, sim_num))
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', '%s_hiepsilon_%sruns' %(exp_type, sim_num))
