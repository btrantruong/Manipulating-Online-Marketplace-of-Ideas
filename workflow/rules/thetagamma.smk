...
CONFIG_PATH = os.path.join(ABS_PATH, "config_01202023")
...
RES_DIR = os.path.join(ABS_PATH,'results', 'short', f'01202023_{exp_type}_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results', 'verbose', f'01202023_{exp_type}_{sim_num}runs')
