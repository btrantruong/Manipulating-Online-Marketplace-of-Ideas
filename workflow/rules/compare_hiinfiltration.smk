...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', '%s_hi_%sruns' %(exp_type, sim_num))
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', '%s_hi_%sruns' %(exp_type, sim_num))
