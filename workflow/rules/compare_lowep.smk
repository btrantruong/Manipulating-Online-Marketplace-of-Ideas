...
CONFIG_PATH = os.path.join(ABS_PATH, "data_lowepsilon")

config_fname = os.path.join(ABS_PATH, "data_lowepsilon", 'all_configs.json')
...
RES_DIR = os.path.join(ABS_PATH,'newpipeline', 'results', '%s_epsilon0.01_beta0.05gamma0.005_%sruns' %(exp_type, sim_num))
TRACKING_DIR = os.path.join(ABS_PATH,'newpipeline', 'verbose', '%s_epsilon0.01_beta0.05gamma0.005_%sruns' %(exp_type, sim_num))
